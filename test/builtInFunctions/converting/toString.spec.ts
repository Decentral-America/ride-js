...
describe('toString & toUtf8String', () => {
  const toStringFn = `toString(callerTestData)`;
  ...
  const precondition = new GenerateContractForBuiltInFunctions(toStringFn);
  precondition.setData('String');

  test.each([
    // toString
    [data.STDLIB_VERSION_3, toStringFn, random.getRandomAddress(), data.positiveTestType],
    [data.STDLIB_VERSION_3, toStringFn, false, data.positiveTestType],
    [data.STDLIB_VERSION_3, toStringFn, random.getRandomInt(), data.positiveTestType],
    [data.STDLIB_VERSION_4, toStringFn, random.getRandomAddress(), data.positiveTestType],
    [data.STDLIB_VERSION_4, toStringFn, true, data.positiveTestType],
    [data.STDLIB_VERSION_4, toStringFn, random.getRandomInt(), data.positiveTestType],
    [data.STDLIB_VERSION_5, toStringFn, random.getRandomAddress(), data.positiveTestType],
    [data.STDLIB_VERSION_5, toStringFn, false, data.positiveTestType],
    [data.STDLIB_VERSION_5, toStringFn, random.getRandomInt(), data.positiveTestType],
    // invalid data in toString
    [data.STDLIB_VERSION_5, toStringFn, random.getRandomAlias(), data.negativeTestType],
